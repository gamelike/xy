 ...
 * 表名:kf_zzb_zba
 */
public class Kf_zzb_zba extends BasePo<Kf_zzb_zba> {
    // 序列化版本号
    private static final long serialVersionUID = 1L;

    public static final RowMapper<Kf_zzb_zba> ROW_MAPPER = new BeanPropertyRowMapper<>(Kf_zzb_zba.class);
    ...
    */
     ...
     */
    @Override
    public Kf_zzb_zba mapRow(ResultSet rs, int i) throws SQLException {
     ...
     */
    @Override
    public Kf_zzb_zba clone() {
        try {
            Kf_zzb_zba kf_zzb_zba = (Kf_zzb_zba) super.clone();
            //主键
            if (this.isset_id) {
                kf_zzb_zba.setId(this.getId());
            }
            //普通属性
            if (this.isset_fid) {
                kf_zzb_zba.setFid(this.getFid());
            }
            if (this.isset_danhwb) {
                kf_zzb_zba.setDanhwb(this.getDanhwb());
            }
            if (this.isset_duohwb) {
                kf_zzb_zba.setDuohwb(this.getDuohwb());
            }
            if (this.isset_xlk) {
                kf_zzb_zba.setXlk(this.getXlk());
            }
            if (this.isset_xlkdx) {
                kf_zzb_zba.setXlkdx(this.getXlkdx());
            }
            if (this.isset_dxk) {
                kf_zzb_zba.setDxk(this.getDxk());
            }
            if (this.isset_fxk) {
                kf_zzb_zba.setFxk(this.getFxk());
            }
            if (this.isset_rq) {
                kf_zzb_zba.setRq(this.getRq());
            }
            if (this.isset_rqsj) {
                kf_zzb_zba.setRqsj(this.getRqsj());
            }
            if (this.isset_yh) {
                kf_zzb_zba.setYh(this.getYh());
            }
            if (this.isset_yhmc) {
                kf_zzb_zba.setYhmc(this.getYhmc());
            }
            if (this.isset_jg) {
                kf_zzb_zba.setJg(this.getJg());
            }
            if (this.isset_jgmc) {
                kf_zzb_zba.setJgmc(this.getJgmc());
            }
            if (this.isset_qy) {
                kf_zzb_zba.setQy(this.getQy());
            }
            if (this.isset_qydx) {
                kf_zzb_zba.setQydx(this.getQydx());
            }
            if (this.isset_tp) {
                kf_zzb_zba.setTp(this.getTp());
            }
            if (this.isset_fj) {
                kf_zzb_zba.setFj(this.getFj());
            }
            if (this.isset_cjsj) {
                kf_zzb_zba.setCjsj(this.getCjsj());
            }
            if (this.isset_beiz) {
                kf_zzb_zba.setBeiz(this.getBeiz());
            }
            if (this.isset_sxh) {
                kf_zzb_zba.setSxh(this.getSxh());
            }
            return kf_zzb_zba;
        } catch (Exception e) {
