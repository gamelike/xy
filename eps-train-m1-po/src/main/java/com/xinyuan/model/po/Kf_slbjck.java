 ...
 * 表名:kf_slbjck
 */
public class Kf_slbjck extends BasePo<Kf_slbjck> {
    // 序列化版本号
    private static final long serialVersionUID = 1L;

    public static final RowMapper<Kf_slbjck> ROW_MAPPER = new BeanPropertyRowMapper<>(Kf_slbjck.class);
    ...
    */
     ...
     */
    @Override
    public Kf_slbjck mapRow(ResultSet rs, int i) throws SQLException {
     ...
     */
    @Override
    public Kf_slbjck clone() {
        try {
            Kf_slbjck kf_slbjck = (Kf_slbjck) super.clone();
            //主键
            if (this.isset_id) {
                kf_slbjck.setId(this.getId());
            }
            //普通属性
            if (this.isset_danhwb) {
                kf_slbjck.setDanhwb(this.getDanhwb());
            }
            if (this.isset_duohwb) {
                kf_slbjck.setDuohwb(this.getDuohwb());
            }
            if (this.isset_xlk) {
                kf_slbjck.setXlk(this.getXlk());
            }
            if (this.isset_xlkdx) {
                kf_slbjck.setXlkdx(this.getXlkdx());
            }
            if (this.isset_dxk) {
                kf_slbjck.setDxk(this.getDxk());
            }
            if (this.isset_fxk) {
                kf_slbjck.setFxk(this.getFxk());
            }
            if (this.isset_rq) {
                kf_slbjck.setRq(this.getRq());
            }
            if (this.isset_rqsj) {
                kf_slbjck.setRqsj(this.getRqsj());
            }
            if (this.isset_yh) {
                kf_slbjck.setYh(this.getYh());
            }
            if (this.isset_yhmc) {
                kf_slbjck.setYhmc(this.getYhmc());
            }
            if (this.isset_jg) {
                kf_slbjck.setJg(this.getJg());
            }
            if (this.isset_jgmc) {
                kf_slbjck.setJgmc(this.getJgmc());
            }
            if (this.isset_qy) {
                kf_slbjck.setQy(this.getQy());
            }
            if (this.isset_qydx) {
                kf_slbjck.setQydx(this.getQydx());
            }
            if (this.isset_tp) {
                kf_slbjck.setTp(this.getTp());
            }
            if (this.isset_fj) {
                kf_slbjck.setFj(this.getFj());
            }
            if (this.isset_cjsj) {
                kf_slbjck.setCjsj(this.getCjsj());
            }
            if (this.isset_beiz) {
                kf_slbjck.setBeiz(this.getBeiz());
            }
            if (this.isset_sxh) {
                kf_slbjck.setSxh(this.getSxh());
            }
            return kf_slbjck;
        } catch (Exception e) {
