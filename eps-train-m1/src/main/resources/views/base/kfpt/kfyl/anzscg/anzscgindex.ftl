...
<@xy.page_head>
    <@xy.script src="js/bootstrap-hover-dropdown.js"/>
<@xy.page_head_top>
    ...
    <li>
        <div class="package-thumb" name="${table_code.id}">
            ...
            <div class="package-thumb-tool">
                <div class="btn-group">
                    <button type="button" class="btn btn-action" data-toggle="dropdown" data-hover="dropdown" onclick="stopBubble();"><i class="iconfont icon-diandian"></i>
                    </button>
